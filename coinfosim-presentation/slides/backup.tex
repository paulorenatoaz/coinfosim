...
\begin{frame}{Resultados adicionais — Occupancy e Air Quality}
  ...
  {\fontsize{7.3}{8.7}\selectfont\color{CoInfoGray}
    $\rankrho$/$\AW{}$: herdados dos relatórios publicados (esquema anterior, cap.\ 7). $A_R$/$S_R$: exigiriam dados brutos não persistidos localmente --- travessão, nunca zero nem o antigo valor de $N^\star$.}
  \sourcecite{cenários Occupancy 000002, Air Quality 000005/000006; tabelas do capítulo 7 do relatório final.}
\end{frame}
...
\begin{frame}{Resultados adicionais — SUPPORT2}
  ...
  {\fontsize{6.6}{7.8}\selectfont\color{CoInfoGray}
    Bloco inferior: escala reduzida (\texttt{scenario\_run\_id=0}), não comparável linha a linha ao bloco superior.\par}
  \sourcecite{SUPPORT2 000007/000008 (herdados); execução smoke local (recalculada); cap.\ 7 e apênd.\ A/B.}
\end{frame}
