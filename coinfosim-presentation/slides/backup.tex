...
\begin{frame}{Geometrias reais e sintéticas selecionadas $(X_1,X_2)$}
  \eyebrow{Removido dos slides 11--13 por legibilidade; versão ampliada aqui}
  \vspace{0.10cm}
  \centering
  \renewcommand{\arraystretch}{1.0}
  \begin{tabular}{cccc}
    & Dados reais & Gaussiana única & GMM \\
    \rotatebox{90}{\footnotesize\;\;Occupancy} &
    \includegraphics[width=0.245\linewidth,trim=6.5 835 737 39,clip]{\figroot/geometry/occupancy/viz_2d_real_full_000002.png} &
    \includegraphics[width=0.245\linewidth,trim=6.5 835 737 39,clip]{\figroot/geometry/occupancy/viz_2d_gaussian_full_000002.png} &
    \includegraphics[width=0.245\linewidth,trim=6.5 835 737 39,clip]{\figroot/geometry/occupancy/viz_2d_gmm_full_000002.png} \\
    \rotatebox{90}{\footnotesize\;\;Air Quality} &
    \includegraphics[width=0.245\linewidth,trim=6.5 835 737 39,clip]{\figroot/geometry/air_quality/viz_2d_real_full_000005.png} &
    \includegraphics[width=0.245\linewidth,trim=6.5 835 737 39,clip]{\figroot/geometry/air_quality/viz_2d_gaussian_full_000005.png} &
    \includegraphics[width=0.245\linewidth,trim=6.5 835 737 39,clip]{\figroot/geometry/air_quality/viz_2d_gmm_full_000005.png} \\
    \rotatebox{90}{\footnotesize\;\;SUPPORT2} &
    \includegraphics[width=0.245\linewidth,trim=6.5 1717 737 39,clip]{\figroot/geometry/support2/viz_2d_real_full_000008.png} &
    \includegraphics[width=0.245\linewidth,trim=6.5 1717 737 39,clip]{\figroot/geometry/support2/viz_2d_gaussian_full_000008.png} &
    \includegraphics[width=0.245\linewidth,trim=6.5 1717 737 39,clip]{\figroot/geometry/support2/viz_2d_gmm_full_000008.png} \\
  \end{tabular}

  \vspace{0.10cm}
  {\fontsize{8.0}{9.6}\selectfont\color{CoInfoGray}
    Comparação descritiva, restrita ao par de canais $(X_1,X_2)$; não é um teste formal de aderência nem prova de preservação do perfil. Matrizes completas com todos os pares de canais: relatório final, Apêndice~A.}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.43\textwidth}
      \begin{beamercolorbox}[wd=\linewidth,sep=.15cm,rounded=true]{block body}
        ...
        PyPI + GitHub\par
        \href{https://github.com/paulorenatoaz/coinfosim}{\texttt{github.com/paulorenatoaz/coinfosim}}\par\vspace{.10cm}
