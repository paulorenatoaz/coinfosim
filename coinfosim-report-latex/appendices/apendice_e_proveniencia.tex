...
\begin{itemize}
  ...
  \item a proveniência é de escopo cenário/braço, não por replicação, subconjunto de atributos ou célula de matriz --- perguntas nesse nível de granularidade devem ser respondidas pelos resultados brutos persistidos (Apêndice~A), não pelo grafo formal;
