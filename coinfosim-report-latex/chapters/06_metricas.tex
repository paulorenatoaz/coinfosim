...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/wr_matrices/support2_smoke/winner_matrix_real_to_real_n32.png}
    \subcaption{$\mathbf{W}(n{=}32)$, \RealToReal}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/wr_matrices/support2_smoke/reversal_matrix_real_to_real_n32.png}
  ...
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/wr_matrices/support2_smoke/winner_matrix_single_gaussian_to_real_n32.png}
    \subcaption{$\mathbf{W}(n{=}32)$, \GaussianToReal}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/wr_matrices/support2_smoke/reversal_matrix_single_gaussian_to_real_n32.png}
