...
\begin{figure}[H]
  ...
  \notailustracao{Sete subconjuntos de referência (um por cardinalidade, selecionados pela menor perda média em $n=512$) entre os 127 do SUPPORT2, para manter a matriz legível; a leitura completa dos 127 subconjuntos permanece disponível no relatório HTML republicado (Apêndice~A). Os valores numéricos de $\AR$, $\DR$ e $\SR$ deste braço e classificador são reportados no Capítulo~7 (Seção~\ref{sec:support2-rf})}
\end{figure}
\end{landscape}
