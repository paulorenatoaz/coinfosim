% Diagrama F — quadrante conceitual: desempenho preditivo vs. preservação do perfil de cooperação preditiva.
...
\begin{tikzpicture}
  ...
  \draw[seta] (0,-0.35) -- (\L,-0.35) node[midway, below=2mm, rotulo] {preservação do perfil de cooperação preditiva};

  % Conteúdo dos quadrantes
  \node[align=center, font=\small, text width=4.9cm] at (\L*0.25,\H*0.75)
    {\textbf{preditivo alto,\\perfil pouco preservado}\\[1mm]
  ...
  \node[align=center, font=\small, text width=4.9cm] at (\L*0.75,\H*0.75)
    {\textbf{preditivo alto,\\perfil preservado}\\[1mm]
     \footnotesize\itshape situação ideal: previsão e leitura do perfil consistentes};
  \node[align=center, font=\small, text width=4.9cm] at (\L*0.25,\H*0.25)
    {\textbf{preditivo baixo,\\perfil pouco preservado}\\[1mm]
     \footnotesize\itshape pouca utilidade preditiva\\e pouca preservação do perfil};
  \node[align=center, font=\small, text width=4.9cm] at (\L*0.75,\H*0.31)
    {\textbf{preditivo baixo,\\perfil preservado}\\[1mm]
  ...
  \node[rotulo, right=1.5mm of rf, text=CoinAccentDark, align=left]
    {SUPPORT2 + Random Forest (concordância de inversões; caso específico)};
\end{tikzpicture}
\end{document}
