...
Compilação do diagrama TikZ conceitual: `xelatex prov_profile_derivation.tex` a partir de `provenance/src/`, reutilizando `figures/conceptual/src/preamble_diagrams.tex`; determinística, sem dependência de Graphviz.
